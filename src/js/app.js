...
window.onload = function() {
  window.variables = {
    ...
    background:
      "https://media.istockphoto.com/id/1329808536/photo/digital-transformation-concept-system-engineering-binary-code-programming.jpg?b=1&s=170667a&w=0&k=20&c=w9-dHReSyld-JOAMG0-jTfsDqhslCvQifuW-9XcDm3I=",
    // this is the url for the profile avatar
    avatarURL: "public/assets/img/perfilpictureCarlos.png",
    // social media bar position (left or right)
    socialMediaPosition: "position-left",
    // social media usernames
    twitter: "carlossosa2021",
    github: "carlossosa99",
    linkedin: "carlosalbertosg2022",
    instagram: "carlossosa__99",
    name: "Carlos",
    lastname: "Sosa",
    role: "Web Developer",
    country: "USA",
